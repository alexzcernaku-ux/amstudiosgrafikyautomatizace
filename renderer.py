...
def render_multi(template_names: list, data: dict) -> list:
    """Pro carousely — vyrenderuje víc slidů najednou, vrátí seznam PNG bytes."""
    return [render(name, data) for name in template_names]
